...
class ChallengeController extends Controller
{
    ...
    public function getEachChallenge($id)
    {
        ...
        return view('frontend.challenge.detail', ['id' => $id, 'balance' => $balance, 'bets' => $bets, 'challenge' => $challenge, 'rate' => $rate, 'setting' => $setting]);
    }
    ...
    public function CreateDepositPaypal($paypal_amount)
    {
        // dd("asdf");
